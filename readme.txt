...
**VERY IMPORTANT:** This plugin is deprecated and will not be mantained anymore. Please consider using [Stage WP Plugin Manager](http://wordpress.org/plugins/stage-wp-plugin-manager/) instead.
